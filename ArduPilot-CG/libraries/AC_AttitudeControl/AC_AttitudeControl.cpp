...
//## Input a forward thurst to the controller
void AC_AttitudeControl::input_thrust_forward( float pilot_forward_throttle){

    // Should think about a way of defining thurst/speed in different ways
    _vel_target_forward = pilot_forward_throttle;
}
...
//## calculate the wanted 
float AC_AttitudeControl::vel_target_to_motor_forward(float vel_target_ms){

    float output = _vel_target_forward;
