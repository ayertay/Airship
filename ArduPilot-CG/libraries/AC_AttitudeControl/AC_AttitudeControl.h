...
public:
    ...
    //## Forward function for assigning forward thurst
    void input_thrust_forward( float pilot_forward_throttle);
...
protected:
    ...
    //## Run the forward movement PID controller and return the output
    float vel_target_to_motor_forward(float vel_target_ms);
    ...
    //## wanted speed of the vehicle
    float               _vel_target_forward;
