...
public:
    ...
    /// Constructor
    AC_WPNav(const AP_InertialNav& inav, AP_AHRS& ahrs, AC_PosControl& pos_control, const AC_AttitudeControl& attitude_control);
    ...
    //## update wpnav_heading, custom navigation controller for the Airship
    float update_wpnav_heading();
