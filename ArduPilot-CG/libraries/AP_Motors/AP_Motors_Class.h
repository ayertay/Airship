...
public:
    ...
    struct AP_Motors_limit {
        ...
        uint8_t forward         : 1; //## Airship specific limits
        uint8_t roll            : 1;
        uint8_t pitch_lower     : 1;
        uint8_t pitch_upper     : 1;
    } limit;
...
protected:
    ...
    float               _forward_in;                //## desired forward thrust from the navigation controller, -1 ~ +1
